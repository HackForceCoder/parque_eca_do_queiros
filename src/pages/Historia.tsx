    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-green-50 p-6">
            <div className="bg-white rounded-lg shadow-lg p-8 max-w-5xl w-full">
                <h1 className="text-5xl font-bold mb-8 text-center" style={{ fontFamily: "'Cormorant Garamond', serif", color: "#1b4332" }}>
                    Nuestra Historia
                </h1>
                ...
                <div className="space-y-12">
                    <section className="flex flex-col lg:flex-row items-center gap-6 text-left px-4 lg:px-0">
                        ...
                        <img src={panoramica} alt="Panorámica" className="w-full lg:w-5/12 rounded-xl shadow-md object-cover max-h-[380px]" />
                    </section>
